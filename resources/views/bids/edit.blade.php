...
<form action="/bids/{{$bid->id}}" method="POST">
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <input type="datetime-local" class="form-control" name="registration_start_date"
                value="{{ inputDateFormat($bid->registration_start_date) }}">
        </div>
        <div class="form-group col">
            <label>Registration End Date</label>
            <input type="datetime-local" class="form-control" name="registration_end_date"
                value="{{ inputDateFormat($bid->registration_end_date) }}">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" class="form-control" name="info_date"
            value="{{ inputDateFormat($bid->info_date) }}">
    </div>

    <div class="form-group">
        <label>Submission Date</label>
        <input type="datetime-local" class="form-control" name="submission_date"
            value="{{ inputDateFormat($bid->submission_date) }}">
    </div>

    <div class="form-group">
        <label>Agreement Date</label>
        <input type="datetime-local" class="form-control" name="agreement_date"
            value="{{ inputDateFormat($bid->agreement_date) }}">
    </div>

    <div class="form-group">
        <label>Extended Date</label>
        <input type="datetime-local" class="form-control" name="extended_date"
            value="{{ inputDateFormat($bid->extended_date) }}">
    </div>
